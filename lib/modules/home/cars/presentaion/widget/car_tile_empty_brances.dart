...
class CarTileEmptyInBranches extends StatefulWidget {
  final int index;
  final cubit;
  ...
  @override
  State<CarTileEmptyInBranches> createState() => _CarTileState();
}

class _CarTileState extends State<CarTileEmptyInBranches> {
  bool? lookLike = true;
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          image: DecorationImage(
                                            image: NetworkImage(widget.cubit
                                                .data[widget.index].photo),
                                            onError: (e, s) {
                                              BlocProvider.of<CarsCubit>(
                                                      context)
                                                  .emitPhotoError(e);
                                            },
                                          ),
