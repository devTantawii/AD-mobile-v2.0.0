            ...
            children: [
              Column(
                children: [
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(locale.orderDetails.toString(),style: TextStyle(
                                    fontSize: 16.sp,
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 3.0),
                                child: Text(
                                  locale.payment.toString(),style: TextStyle(
                                    fontSize: 16.sp,
                                    fontWeight: FontWeight.w500,
                  ...
                  Container(child: Center(child: Image.asset("assets/images/DoneBooking.png"))),
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(locale.bookingConfirmed!, style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontSize: 20.sp)),
                        SizedBox(height: 10),
                        // Text(
                        ...
                        GestureDetector(
                          ...
                          child: ADGradientButton( locale.goToHome.toString(),),
                        )
                      ],
                    ),
                  ),
